        ...
        <div class="account" >
            ...
            <div class="accountEditArea">
                <form action="edit_bank.php" method="POST">
                    <section class="other">
                    <label>ชื่อธนาคาร</label><input class="password" type="text" id="n_bank_name" name="n_bank_name" required><br>
                    <label>ชื่อบัญชี</label><input class="password" type="text" id="n_acc_name" name="n_acc_name" required><br>
                    <label>เลขบัญชี</label><input class="password" type="tel" id="n_bank_acc" name="n_bank_acc" minlength="10" maxlength="15" size="15" required><br>
                    <button class="submit" type="submit" name="edit_bank">เสร็จสิ้น</button></a>
                </form>
            </div>
        <div>
    </div>
